...
try:
    from localpoly import __version__ as version
except ImportError:
    pass
else:
    release = version
...
# of the sidebar.
# html_logo = "./_static/localpoly-python-logo.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# html_favicon = "./_static/localpoly-python-favicon.png"
...
htmlhelp_basename = "localpoly-doc"
